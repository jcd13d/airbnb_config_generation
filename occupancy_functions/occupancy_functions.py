...
def create_config(occupancy_template, months_into_future, s3_output_path):
...
def create_occupancy_configs(occupancy_template, months_into_future, out_path, s3_output_path):
    configs = [create_config(occupancy_template, months_into_future, s3_output_path)]
